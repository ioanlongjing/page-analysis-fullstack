...
export const EXAMPLES_SIGN_IN_BEGIN = 'EXAMPLES_SIGN_IN_BEGIN';
export const EXAMPLES_SIGN_IN_SUCCESS = 'EXAMPLES_SIGN_IN_SUCCESS';
export const EXAMPLES_SIGN_IN_FAILURE = 'EXAMPLES_SIGN_IN_FAILURE';
export const EXAMPLES_SIGN_IN_DISMISS_ERROR = 'EXAMPLES_SIGN_IN_DISMISS_ERROR';
